...
class LibrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create libro" do
    assert_difference('Libro.count') do
      post libros_url, params: { libro: { autor: @libro.autor, estado: @libro.estado, fecha_devolucion: @libro.fecha_devolucion, fecha_prestado: @libro.fecha_prestado, titulo: @libro.titulo } }
    end
  ...
  test "should update libro" do
    patch libro_url(@libro), params: { libro: { autor: @libro.autor, estado: @libro.estado, fecha_devolucion: @libro.fecha_devolucion, fecha_prestado: @libro.fecha_prestado, titulo: @libro.titulo } }
